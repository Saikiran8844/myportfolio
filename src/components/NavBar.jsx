    ...
    return (
        <div className='flex justify-between items-center w-full h-20 px-4 text-white bg-gradient-to-b from-gray-800 to-black'>
            <div className='flex flex-row gap-1'>
                <h3 className='text-3xl font-itim ml-4 animate-text bg-gradient-to-r from-teal-500 via-purple-500 to-orange-500 bg-clip-text text-transparent text-2xl font-black'>Saikiran</h3>
            </div>
